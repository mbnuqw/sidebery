export default {
  ...
  'settings.sel_opened_bookmarks': { message: 'Выделять открытые закладки' },
  'settings.act_opened_tab': { message: 'Переходить на открытую вкладку вместо открытия новой' },
  ...
  'settings.switch_theme': { message: 'Стиль' },
  'settings.theme_dark': { message: 'темный' },
  'settings.theme_light': { message: 'светлый' },
  'settings.look': { message: 'Тема' },
  'settings.look_default': { message: 'стандартная' },
  'settings.look_aluminium': { message: 'алюминий' },
  'settings.look_base': { message: 'базовая' },
