export default {
  ...
  'container_dashboard.proxy_host_placeholder': { message: 'host' },
  'container_dashboard.proxy_port_placeholder': { message: 'port' },
  'container_dashboard.proxy_username_placeholder': { message: 'username' },
  'container_dashboard.proxy_password_placeholder': { message: 'password' },
