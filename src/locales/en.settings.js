export default {
  ...
  'settings.switch_theme': { message: 'Style' },
  'settings.theme_dark': { message: 'dark' },
  'settings.theme_light': { message: 'light' },
  'settings.look': { message: 'Theme' },
  'settings.look_default': { message: 'default' },
  'settings.look_aluminium': { message: 'aluminium' },
  'settings.look_base': { message: 'base' },
