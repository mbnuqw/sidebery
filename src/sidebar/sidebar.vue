...
#root.root.Sidebar(
  ...
  :data-tabs-multiline-title="Settings.tabsMultiLineTitle"
  :data-tabs-title-br="Settings.state.tabsTitleLinesBr"
  :style="{ '--tabs-title-lines-max': Settings.tabsTitleLinesMax }"
