...
export const setupPageTranslations: Translations = {
  ...
  'panel.new_tab_ctx_reopen': {
    ...
    de: 'Erkenne extern geöffneten Tab und öffne ihn bei der ersten Anfrage erneut in der Zielumgebung (globale Einstellung)',
  ...
  'settings.dnd_act_tab_from_link': {
    ...
    de: 'Aktiviere Tab, welcher durch eine hineingezogene Verknüpfung erstellt wurde',
  ...
  'settings.dnd_act_search_tab': {
    ...
    de: 'Aktiviere Tab, welcher durch einen hineingezogenen Text zwecks Suche erstellt wurde',
  ...
  'settings.dnd_move_tabs': {
    ...
    de: 'Schließe Tabs nachdem sie auf Lesezeichen losgelassen wurden',
  ...
  'settings.dnd_move_tabs_note': {
    ...
    de: 'Hinweis: Strg+Loslassen wird die Tabs erhalten',
  ...
  'settings.dnd_move_bookmarks': {
    ...
    de: 'Lösche Lesezeichen nachdem sie auf Tabs losgelassen wurden',
  ...
  'settings.dnd_move_bookmarks_note': {
    ...
    de: 'Hinweis: Strg+Loslassen wird die Lesezeichen erhalten',
...
例：「*」、「ctrl+$」、「ctrl+alt+g」`,
  ...
  'settings.switch_panel_after_switching_tab': {
    ...
    de: 'Panel automatisch wechseln bei Aktivierung eines Tabs eines anderen Panels',
  ...
  'settings.tabs_update_mark_first': {
    ...
    de: 'Einschließlich der ersten Titel-Änderung bei einer neuen URL',
  ...
  'settings.tabs.inherit_custom_color': {
    ...
    de: 'Gewählte Farbe in untergeordneten Tabs übernehmen',
