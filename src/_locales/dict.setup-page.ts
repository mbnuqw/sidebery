...
export const setupPageTranslations: Translations = {
  ...
  'container.rules_include_tooltip': {
    ...
    fr: 'Rouvrir les onglets avec l’URL correspondante dans ce conteneur.\nListe de “sous-chaine” ou “/RegExp/” avec une entrée par ligne:\n    example.com\n    /^(some)?regex$/\n    …',
  ...
  'container.rules_exclude_tooltip': {
    ...
    fr: `Rouvrir les onglets avec l’URL correspondante dans le conteneur par défaut.\nListe de “sous-chaine” ou “/RegExp/” avec une entrée par ligne:
    example.com
    /^(some)?regex$/
    …`,
  ...
  'panel.temp_mode_label': {
    ...
    fr: 'Basculer sur le dernier panneau d’onglets actif à la sortie de la souris',
  ...
  'panel.new_tab_ctx_reopen': {
    ...
    // TODO: review trad
    fr: 'Détecter les onglets ouverts exterieurement et les rouvrir dans le conteneur cible à la première requête Web (paramètre global)',
  ...
  'panel.drop_tab_ctx': {
    ...
    fr: 'Rouvrir les onglets qui ont été déplacés dans ce panel dans le conteneur:',
  ...
  'panel.move_tab_ctx': {
    ...
    fr: 'Déplacer les onglets dans ce panel s’ils ont été ouverts dans le conteneur:',
  ...
  'panel.move_rules_active': {
    ...
    fr: 'Déplacer les onglets vers ce panel',
  ...
  'panel.url_rules': {
    ...
    fr: 'Déplacer les onglets avec les URL correspondantes dans ce panneau',
  ...
  'panel.auto_convert': {
    ...
    // TODO: wtf ça veut dire quoi
    fr: 'Convertir en panneau d’onglets source à l’ouverture de marque-pages',
  ...
  'panel.custom_icon_note': {
    ...
    // TODO: pas terrible?
    fr: 'Syntaxe de la valeur textuelle: “text::couleur::valeur-CSS-font”',
  ...
  'panel.root_id_wrong': {
    ...
    fr: 'Impossible de trouver le dossier, veuillez en choisir un nouveau',
  ...
  'panel.move_excluded_to': {
    ...
    fr: 'Déplacer les onlgets sans correspondance (exclus) dans le panneau',
  ...
  'settings.nav_settings_tabs_preview': {
    en: 'Tabs preview',
    de: 'Tab-Vorschau',
    fr: 'Prévisualisation des onglets',
    hu: 'Előnézet',
    pl: 'Podgląd kart',
  ...
  'settings.native_scrollbars_thin': {
    ...
    fr: 'Utiliser des barres de défilement fines',
  ...
  'settings.native_scrollbars_left': {
    ...
    fr: 'Afficher la barre de défilement à gauche',
  ...
  'settings.sel_win_screenshots': {
    ...
    fr: 'Afficher les captures d’écran dans le menu de selection des fenêtres lors du déplacement d’onglets via le menu contextuel',
  ...
  'settings.mark_window': {
    ...
    fr: 'Ajouter un prefix au titre de la fenêtre du navigateur quand la barre latérale de Sidebery est active',
  ...
  'settings.copy_multi_bullet': {
    ...
    // TODO: c pas vrmt une puce
    fr: 'Ajouter une puce de liste lors de la copie de plusieurs éléments',
...
Available variables: %B - a list mark (bullet); %CT - custom title or title; %T - title; %U - URL`,
    fr: `Pour utiliser cette foncitonnalité, activez l’option “Copier avec un modèle” dans l’éditeur de menus contextuels ou définissez un raccourci clavier.
    Les modèles sont écrit un par ligne en suivant la forme “Nom du modèle:Modèle” (sans les guillemets).`,
...
注意：清單標記僅會在透過範本複製多個項目時新增`,
  ...
  'settings.storage_delete_confirm': {
    en: 'Delete property ',
    de: 'Feld löschen ',
    // TODO: pas vraiment une 'propriété'
  ...
  'settings.clipboard_write_info': {
    ...
    fr: 'Requis pour:\n– Copier les URLs des onlgets ou marque-pages via le menu contextuel',
  ...
  'settings.clipboard_read_info': {
    en: 'Required for:\n- Paste function',
    de: 'Benötigt für:\n- Einfügefunktion',
    // TODO: chaine initiale pas top
    fr: 'Requis pour:\n– La fonctionnalité de collage',
    hu: 'A következő funkciókhoz szükséges:\n– Beillesztés funkció',
  ...
  'settings.perm.downloads_info': {
    ...
    fr: 'Requis pour:\n– L’exportation automatique des instantanés',
  ...
  'settings.ctx_menu_ignore_ctr_note': {
    ...
    fr: 'Liste de nom de conteneurs ou /RegExp/ séparés par des virgules',
  ...
  'settings.nav_btn_count': {
    ...
    fr: 'Afficher le nombre d’onglets ou marque-pages',
  ...
  'settings.nav_switch_panels_delay': {
    ...
    fr: 'Durée minimum entre le basculement des panneaux (ms)',
  ...
  'settings.sub_panel.recently_closed_tabs': {
    ...
    fr: 'Sous-panneau des onglets récemment fermés',
  ...
  'settings.sub_panel.bookmarks': {
    ...
    fr: 'Sous-panneau des marque-pages',
    hu: 'Könyvjelzők',
  ...
  'settings.sub_panel.history': {
    ...
    fr: 'Sous-panneau de l’historique',
    hu: 'Előzmények',
  ...
  'settings.nav_rm_tabs_panel_confirm_post': {
    ...
    fr: '”?\nTous les onglets de ce panneau seront assignés au panneau le plus proche.',
  ...
  'settings.dnd_exp': {
    ...
    fr: 'Déplier/replier la branche au survol sur',
  ...
  'settings.dnd_act_tab_from_link': {
    ...
    fr: 'Activer l’onglet créé par lien déposé',
  ...
  'settings.dnd_act_search_tab': {
    ...
    fr: 'Activer l’onglet de rechercher créé par du texte déposé',
  ...
  'settings.dnd_move_tabs_note': {
    ...
    fr: 'Note: Ctrl+Déposer va éviter la fermeture des onglets',
  ...
  'settings.dnd_move_bookmarks_note': {
    ...
    fr: 'Note: Ctrl+Déposer va éviter la suppression des marque-pages',
  ...
  'settings.search_panel_switch': {
    ...
    fr: 'Continuer de chercher après un changement de panneau',
...
例：「*」、「ctrl+$」、「ctrl+alt+g」`,
  ...
  'settings.search.bookmarks_shortcut': {
    ...
    fr: 'Basculer sur les marque-pages',
  ...
  'settings.activate_last_tab_on_panel_switching': {
    ...
    fr: 'Activer le dernier onglet lors du basculement sur un panneau',
  ...
  'settings.switch_panel_after_switching_tab': {
    ...
    fr: 'Basculer automatiquement de panneau lors de l’activation d’un onglet d’un autre panneau',
  ...
  'settings.activate_after_closing': {
    ...
    fr: 'Après la fermeture de l’onglet actif en cours',
  ...
  'settings.activate_after_closing_stay_in_panel': {
    ...
    fr: 'Rester dans le panneau du dernier onglet',
  ...
  'settings.tabs_unread_mark': {
    ...
    fr: 'Afficher un indicateur sur les onglets non lu',
  ...
  'settings.tabs_update_mark': {
    ...
    fr: 'Afficher un indicateur sur les onglets dont le titre à changer',
  ...
  'settings.tabs_panel_switch_act_move': {
    ...
    fr: 'Basculer sur le panneau après le déplacement manuellement de l’onglet actif vers un autre panneau',
  ...
  'settings.tabs_panel_switch_act_move_auto': {
    ...
    fr: 'Basculer sur le panneau après le déplacement automatique de l’onglet actif vers un autre panneau',
  ...
  'settings.tabs_switch_delay': {
    ...
    fr: 'Durée minimum entre le basculement d’onglets (ms)',
  ...
  'settings.move_new_tab_pin': {
    ...
    fr: 'Emplacement des nouveaux onglets ouverts depuis les onglets épinglés',
  ...
  'settings.move_new_tab_parent': {
    ...
    fr: 'Emplacemeent des nouveaux onglets ouverts depuis un autre onglet',
  ...
  'settings.move_new_tab_none': {
    en: 'none',
    de: 'Nichts',
    // TODO: 'none' ça veut pas dire grand chose ici :'(
    fr: 'ne pas le déplacer',
    hu: 'semmi',
    pl: 'brak',
    ru: 'выкл',
  ...
  'settings.pinned.no_unload': {
    ...
    fr: 'Empêcher les ongletes épinglés de se décharger',
  ...
  'settings.tabs_tree_layout': {
    ...
    // TODO: changer pour coller à la source? (je me suis inspiré'e de l'allemand)
    fr: 'Activer l’arborescence onglets',
  ...
  'settings.group_on_open_layout': {
    ...
    fr: 'Créer une sous-arborescence à l’ouverture d’un lien dans un nouvel onglet',
  ...
  'settings.tabs_tree_limit': {
    ...
    fr: 'Niveau maximal arborescence d’onglets',
  ...
  'settings.auto_exp_tabs_on_new': {
    ...
    fr: 'Déplier automatiquement les branches à la création d’un onglet enfant',
  ...
  'settings.rm_child_tabs': {
    ...
    fr: 'Fermer les onglets enfants avec le parent',
  ...
  'settings.auto_group_on_close': {
    ...
    fr: 'Grouper automatiquement les onglets enfant après la fermeture du l’onglet parent',
  ...
  'settings.auto_group_on_close_0_lvl': {
    ...
    fr: 'Seulement si l’onglet fermé était à la racine de l’arboresence',
  ...
  'settings.auto_group_on_close_mouse_only': {
    ...
    fr: 'Seulement si l’onglet a été fermé avec la souris',
  ...
  'settings.tabs.inherit_custom_color': {
    ...
    fr: 'Hériter les couleurs personalisées dans les onglets enfants',
  ...
  'settings.tabs.preview': {
    ...
    fr: 'Afficher la prévisualisation des onglets au survol de la souris',
  ...
  'settings.tabs.preview_mode_n': {
    ...
    fr: 'ne pas afficher de prévisualisation',
  ...
  'settings.tabs.preview_inline_height': {
    ...
    de: 'Vorschauhöhe (px)',
    fr: 'Hauteur de la prévisualisation (px)',
  ...
  'settings.tabs.preview_popup_width': {
    ...
    fr: 'Largeur de la prévisualisation (px)',
  ...
  'settings.tabs.preview_url': {
    ...
    fr: 'Nombre de ligne maximim pour l’URL',
  ...
  'settings.tabs.preview_follow_mouse': {
    ...
    fr: 'Suivre le cursor de la souris',
  ...
  'settings.tabs.preview_crop_right': {
    ...
    fr: 'Rogner la prévisualisation depuis le côté droit (px)',
  ...
  'settings.hide_folded_parent': {
    ...
    fr: 'Aussi cacher l’onglet parent',
  ...
  'settings.native_highlight': {
    ...
    fr: 'Mettre en évidence les onglets natifs (dans la barre horizontal en haut) de la même manière que les onglets de la barre latérale',
  ...
  'settings.native_highlight_note': {
    ...
    fr: 'Cela mettra aussi en évidence l’onglet actif, vu que Firefox n’autorise pas à mettre en évidence seulement les onglets inactifs',
  ...
  'settings.bookmarks_rm_undo_note': {
    ...
    fr: 'Afficher une notification pour annuler la fermeture de plusieurs marque-pages',
  ...
  'settings.show_bookmark_len': {
    ...
    fr: 'Afficher la taille des dossier',
  ...
  'settings.pin_opened_bookmarks_folder': {
    ...
    fr: 'Continuer d’afficher les dossiers ouverts en scrollant',
  ...
  'settings.old_bookmarks_after_save': {
    ...
    fr: 'Quoi faire avec les ancien marque-pages après avoir sauvegarder un panneau d’onglet',
  ...
  'settings.appearance_notes': {
    ...
    fr: '– Pour appliquer un thème de couleur aux boutons de Sidebery dans l’interface du natigateur, définir “svg.context-properties.content.enabled” à “true” dans la page “about:config”',
  ...
  'settings.h_scroll_action': {
    ...
    fr: 'Utiliser le scroll horizontal pour',
  ...
  'settings.h_scroll_action_switch_panels': {
    en: 'switch panels',
    de: 'Panel wechseln',
    fr: 'basculer entres la panneaux',
    hu: 'panelváltás',
    pl: 'przełącz panele',
  ...
  'settings.scroll_through_tabs': {
    ...
    fr: 'Changer d’onglets en utilisant le scroll vertical',
  ...
  'settings.scroll_through_tabs_psp': {
    ...
    fr: 'préselectionner dans le panneau',
  ...
  'settings.scroll_through_tabs_psg': {
    ...
    fr: 'préselectionner dans tous les onglets',
  ...
  'settings.scroll_through_tabs_preselect_note': {
    ...
    fr: 'Selectionner un onglet en utilisant le scroll vertical et l’activer seulement après que la souris soit sortie du panneau',
  ...
  'settings.scroll_through_visible_tabs': {
    ...
    fr: 'Omettre les onglets repliés',
  ...
  'settings.scroll_through_tabs_skip_discarded': {
    ...
    fr: 'Omettre les onglets déchargés',
  ...
  'settings.scroll_through_tabs_except_overflow': {
    ...
    fr: 'Sauf si le panneau est plein',
  ...
  'settings.scroll_through_tabs_scroll_area_note': {
    ...
    fr: 'Positive: à droite du panneau; négative: à gauche du panneau',
  ...
  'settings.auto_menu_multi_sel': {
    ...
    fr: 'Ouvrir le menu contextuel automatiquement après une selection multiple au clic droit',
  ...
  'settings.wheel_threshold': {
    ...
    fr: 'Définir un seuil avant de basculer entre les panneaux et onglets en scrollant',
  ...
  'settings.nav_switch_panels_wheel': {
    ...
    fr: 'Basculer entre les panneaux en utilisant le scroll vertical sur la barre de navigation',
  ...
  'settings.tabs_second_click_act_prev': {
    ...
    // TODO: Uniformiser 'Tab flip' (traduit Onlget revers dans dict.browser.json)
    fr: 'Cliquer sur l’onglet actif active l’onglet précédemment actif (Basculement d’onglets)',
  ...
  'settings.tabs_second_click_act_prev_panel_only': {
    ...
    fr: 'Seulement sur la panneau actif',
  ...
  'settings.activate_on_mouseup': {
    ...
    fr: 'Activer l’onglet à la relache du bouton de la souris',
  ...
  'settings.shift_selection_from_active': {
    ...
    fr: 'Démarrer la selection Maj+Clic depuis l’onglet actif',
  ...
  'settings.ctrl_selection_include_active': {
    ...
    fr: 'Faire que la selection Ctrl+Clic inclue l’onglet actif',
  ...
  'settings.tab_middle_click': {
    ...
    fr: 'Clic du milieu sur un onglet',
  ...
  'settings.multiple_middle_close': {
    ...
    fr: 'Utiliser la selection multiple pour fermer plusieurs onglets avec le clic du milieu',
  ...
  'settings.multiple_middle_close_note': {
    ...
    fr: 'Les onglets sélectionnés seront fermés à la relache du bouton',
  ...
  'settings.tab_close_middle_click': {
    ...
    fr: 'Clic du milieu sur le bouton “fermer l’onglet”',
  ...
  'settings.tabs_panel_middle_click_action': {
    en: 'Middle click on tabs panel',
    de: 'Mittelklick auf Tab-Panel',
    fr: 'Clic du milieu sur un panneau d’onglets',
    hu: 'Középső kattintás egy lappanelon',
    pl: 'Środkowy przycisk myszy na panel kart',
  ...
  'settings.tabs_panel_action_collapse': {
    ...
    fr: 'replier les branche inactives',
  ...
  'settings.tabs_panel_action_undo': {
    ...
    fr: 'annuler la fermeture de l’onglet',
  ...
  'settings.mouse.new_tab_middle_click_action': {
    ...
    fr: 'Clic du milieu sur le bouton “Nouvel onglet”',
  ...
  'settings.mouse.bookmarks.mid_click_action': {
    ...
    fr: 'Clic du milieu sur un marque-page',
  ...
  'settings.mouse.history.mid_click_action': {
    ...
    fr: 'Clic du milieu sur une entrée de l’historique',
  ...
  'settings.snap_exclude_private': {
    ...
    fr: 'Omettre les fenêtres de navigation privée',
...
- Sidebery ファイルは JSON 形式で保存されるため、Google はファイルの内容を読み取ることができます (暗号化が予定されています)`,
  ...
  'settings.sync_gd_api_note': {
    ...
    fr: 'Pour les utilisateurices avancées. Dans le cas où la clé par défaut se fasse bloquer pour cause de dépassement des limites de requête de l’API.',
...
– URIs de redirections authorisées:`,
...
- 授權重新導向 URI：`,
  ...
  'settings.sync_gd_api_id': {
    ...
    fr: '5. Ouvrir le client créé et récupérer l’ID Client',
  ...
  'settings.sync_gd_api_scope': {
    ...
    fr: '6. Ajouter les portées dans la section “Accès aux connées”',
    zh_CN: '6. 在数据访问添加以下范围：',
  ...
  'settings.sync_gd_api_reload': {
    ...
    fr: '9. Déconnecter Sidebery de votre Google Drive',
  ...
  'settings.sync_gd_api_done': {
    ...
    fr: '9. Terminé. Lors de la prochaine requête à Google Drive, il vous sera affiché un écran de demande de consentement',
  ...
  'settings.sync_save_settings': {
    ...
    fr: 'Sauvegarder les paramètre dans l’espace de stockage synchronisé',
...
- データが Firefox 同期サーバーにアップロードされたことを確認するには、Firefox 設定またはメインメニュー（三行ボタン）内のプロファイルで「今すぐ同期」ボタンを押す必要があります`,
  ...
  'settings.help_imp_perm': {
    ...
    fr: 'Des autorisations supplémentaires sont requises',
  ...
  'settings.debug_info': {
    ...
    fr: 'Voir les informations de debuggage',
  ...
  'settings.kb_input': {
    ...
    fr: 'Nouvelle touche de raccourci',
  ...
  'settings.kb_override_popup_title': {
    ...
    fr: 'Le raccourci est déjà affectué.\nRemplacer?',
    hu: 'A billentyűparancs már foglalt.\nFelülírható?',
  ...
  'settings.kb_rm': {
    ...
    fr: 'Fermer les onglets / Supprimer les marque-pages',
...
– activer le panneau sélectionné`,
  ...
  'settings.kb_active_tabs_history': {
    ...
    fr: 'Naviguer dans l’historique des onglets',
  ...
  - "Inspektor"-Tab durchsehen`,
    fr: `NOTE: Pour trouver les sélecteurs CSS actuellement disponibles, utiliser le debuggeur:
  – Cliquer sur le bouton “Copier l’URL des outils de développement” dans la barre en bas de la page
  – Sélectionner un iframe à inspecter
  ...
  'snapshot.btn_create_first': {
    ...
    fr: 'Créer votre premier instantané',
