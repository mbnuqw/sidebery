...
export const setupPageTranslations: Translations = {
  ...
  'settings.containers_sort_by_name': {
    ...
    de: 'Sortieren Sie Umgebungen nach Namen',
  ...
  'settings.dnd_tab_act': {
    ...
    de: 'Tabs beim Darüberschweben aktivieren',
  ...
  'settings.dnd_exp': {
    ...
    de: 'Zweig ein-/ausklappen beim Schweben über',
...
範例： "*", "ctrl+$", "ctrl+alt+g"`,
  ...
  'settings.auto_fold_tabs': {
    ...
    de: 'Zweige beim Öffnen eines anderen Zweiges automatisch einklappen', 
  ...
  'settings.auto_fold_tabs_except': {
    ...
    de: 'Maximal Anzahl offener Zweige',
  ...
  'settings.tabs.preview': {
    ...
    de: 'Tab-Vorschau beim Drüberschweben anzeigen',
