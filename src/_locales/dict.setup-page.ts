...
Liste de “sous-chaines” ou “/RegExp/” avec une entrée par ligne:
  ...
  'settings.nav_settings_anchor_tabs': {
    ...
    pl: 'Zakotwiczone karty',
    ru: 'Привязанные вкладки',
    zh_CN: '锚定标签页',
    zh_TW: '錨定分頁',
    ja: 'アンカータブ',
  },
  'settings.anchor_tabs_reset_indicator': {
    en: 'Reset indicator',
    de: 'Zurücksetzen-Indikator',
    fr: 'Indicateur de réinitialisation',
    hu: 'Visszaállítási jelző',
    pl: 'Wskaźnik resetowania',
    ru: 'Индикатор сброса',
    zh_CN: '重置指示符',
    zh_TW: '重置指示符',
    ja: 'リセットインジケーター',
  ...
  'settings.anchor_tabs_reset_indicator_note': {
    ...
    de: 'Akzeptiert Text und Emojis',
    fr: 'Accepte du texte et des emojis',
    hu: 'Elfogad szöveget és emojikat',
    pl: 'Akceptuje tekst i emoji',
    ru: 'Принимает текст и эмодзи',
    zh_CN: '支持文字和表情符号',
    zh_TW: '支援文字和表情符號',
    ja: 'テキストと絵文字を使用できます',
  },
