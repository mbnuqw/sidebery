...
例：「*」、「ctrl+$」、「ctrl+alt+g」`,
  ...
  'settings.move_new_tab_button': {
    en: 'Place new tab from New Tab button',
    de: 'Neuen Tab über die Schaltfläche „Neuer Tab“ platzieren',
    hu: 'Új lap elhelyezése az Új lap gombról',
    pl: 'Umieść nową kartę za pomocą przycisku Nowa karta',
    ru: 'Разместить новую вкладку с помощью кнопки «Новая вкладка»',
    zh_CN: '通过“新标签页”按钮放置新标签页',
    zh_TW: '透過「新分頁」按鈕放置新分頁',
    ja: '新しいタブボタンから新しいタブを配置する',
  },
