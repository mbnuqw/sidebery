...
%Y - 年; %M - 月; %D - 日; %h - 小時; %m - 分鐘; %s - 秒`,
  ...
  'settings.scroll_through_tabs_scroll_area_note': {
    en: 'Positive - at the left, negative - at the right side of the panel',
    ru: 'Положительное значение - слева, отрицательное - справа на панели',
    de: 'Positiv - linke Seite, Negativ - rechte Seite des Panels',
    zh_CN: '正数 - 在面板左侧，负数 - 在面板右侧',
