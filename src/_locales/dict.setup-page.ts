...
Liste de “sous-chaine” ou “/RegExp/” avec une entrée par ligne:
  ...
  'panel.url_rules': {
    ...
    fr: 'Déplacer les onglets dont les URL correspondent dans ce panneau',
...
例：「*」、「ctrl+$」、「ctrl+alt+g」`,
  ...
  'settings.group_on_open_layout': {
    ...
    fr: 'Créer une sous-arborescence lors de l’ouverture d’un lien dans un nouvel onglet',
