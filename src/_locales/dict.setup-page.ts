...
Például: „*”, „ctrl+$”, „ctrl+alt+g”`,
  ...
  'settings.skip_empty_panels': {
    ...
    zh_CN: '切换时跳过空面板',
    zh_TW: '切換時跳過空面板',
    hu: 'Panelváltáskor az üres panelok kihagyása',
  },
  'settings.tab_rm_btn': {
  ...
  'settings.open_sub_panel_on_mouse_hover': {
    ...
    zh_CN: '在鼠标悬停时打开书签子面板',
    zh_TW: '在滑鼠懸停時開啟書籤子面板',
    hu: 'A könyvjelzőalpanel megnyitása, ha fölé ér az egérmutató',
  },
  'settings.discard_inactive_panel_tabs_delay': {
    ...
    zh_TW: '超過延遲時間後卸載非作用中面板的分頁',
    hu: 'Az inaktív panelok lapjainak késleltetett kisöprése',
  },
...
%Y: év; %M: hónap; %D: nap; %h: óra; %m: perc; %s: másodperc`,
  ...
  'settings.snap_export_path_ph': {
    ...
    hu: 'Sidebery/pillanatkép-%Y.%M.%D-%h:%m:%s',
  },
  ...
  'settings.shift_selection_from_active': {
    ...
    zh_TW: '按住 shift + 點選以從當前分頁位置開始選取區間',
  ...
  'settings.sync_auto_apply': {
    ...
    zh_CN: '自动应用更改',
    zh_TW: '自動應用更改',
    hu: 'A változások automatikus alkalmazása',
  },
...
– A Firefox beállításaiban vagy főmenüjében (gomb három csíkkal) található „Szinkronizálás most” gomb használatával lehet meggyőződni arról, hogy az adatok feltöltése ténylegesen megtörtént.`,
  ...
  'settings.ref_rm': {
    ...
    zh_CN: '将被删除；如果你需要此功能，请提交issue。',
    zh_TW: '將被刪除；如果你需要此功能，請提交issue。',
    hu: 'El lesz távolítva; egy hibajegyben jelezhető, ha szükség lenne a funkcióra.',
  },
