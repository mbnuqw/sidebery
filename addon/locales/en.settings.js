export default {
  ...
  // 'settings.kb Open/Close sidebar panel': { message: 'Open/Close sidebar panel' },
  // 'settings.kb Switch to next panel': { message: 'Switch to next panel' },
  // 'settings.kb Switch to previous panel': { message: 'Switch to previous panel' },
  // 'settings.kb Open new tab in active panel': { message: 'Open new tab in active panel' },
  // 'settings.kb Open new tab after active tab': { message: 'Open new tab after active tab' },
  // 'settings.kb Open new tab as the first child of active tab': { message: 'Open new tab as the first child of active tab' },
  // 'settings.kb Open new tab as the last child of active tab': { message: 'Open new tab as the last child of active tab' },
  // 'settings.kb Remove selected items or active tab': { message: 'Remove selected items or active tab' },
  // 'settings.kb Select all': { message: 'Select all' },
  // 'settings.kb Up': { message: 'Up' },
  // 'settings.kb Down': { message: 'Down' },
  // 'settings.kb Select up': { message: 'Select up' },
  // 'settings.kb Select down': { message: 'Select down' },
  // 'settings.kb Activate selection': { message: 'Activate selection' },
  // 'settings.kb Open menu': { message: 'Open menu' },
  // 'settings.kb Reset selection': { message: 'Reset selection' },
  // 'settings.kb Fold selected branch': { message: 'Fold selected branch' },
  // 'settings.kb Expand selected branch': { message: 'Expand selected branch' },
  // 'settings.kb Fold inactive branches': { message: 'Fold inactive branches' },
  // 'settings.kb Activate previous active tab': { message: 'Activate previous active tab' },
  // 'settings.kb Activate previous active tab of active panel': { message: 'Activate previous active tab of active panel' },
  // 'settings.kb Move selected tabs to the active tab': { message: 'Move selected tabs to the active tab' },
  // 'settings.kb Increase tab\'s tree level (indent)': { message: 'Increase tab\'s tree level (indent)' },
  // 'settings.kb Decrease tab\'s tree level (outdent)': { message: 'Decrease tab\'s tree level (outdent)' },
  // 'settings.kb Move tabs up': { message: 'Move tabs up' },
  // 'settings.kb Move tabs down': { message: 'Move tabs down' },
