export default {
  ...
  // 'settings.kb Open/Close sidebar panel': { message: 'Открыть/Закрыть панель' },
  // 'settings.kb Switch to next panel': { message: 'Переключиться на следующую панель' },
  // 'settings.kb Switch to previous panel': { message: 'Переключиться на предыдущую панель' },
  // 'settings.kb Open new tab in active panel': { message: 'Открыть новый таб в активной панели' },
  // 'settings.kb Open new tab after active tab': { message: 'Открыть новый таб после активной вкладки' },
  // 'settings.kb Open new tab as the first child of active tab': { message: 'Открыть новый дочерний таб (в начале ветви)' },
  // 'settings.kb Open new tab as the last child of active tab': { message: 'Открыть новый дочерний таб (в конце ветви)' },
  // 'settings.kb Remove selected items or active tab': { message: 'Удалить выделенные элементы или активный таб' },
  // 'settings.kb Select all': { message: 'Выделить все' },
  // 'settings.kb Up': { message: 'Вверх' },
  // 'settings.kb Down': { message: 'Вниз' },
  // 'settings.kb Select up': { message: 'Вверх с выделением' },
  // 'settings.kb Select down': { message: 'Вниз с выделением' },
  // 'settings.kb Activate selection': { message: 'Активировать выделенное' },
  // 'settings.kb Open menu': { message: 'Открыть меню' },
  // 'settings.kb Reset selection': { message: 'Сбросить выделение' },
  // 'settings.kb Fold selected branch': { message: 'Свернуть выделенную ветвь' },
  // 'settings.kb Expand selected branch': { message: 'Развернуть выделенную ветвь' },
  // 'settings.kb Fold inactive branches': { message: 'Свернуть неактивные ветви табов' },
  // 'settings.kb Activate previous active tab': { message: 'Активировать предыдущую активную вкладку' },
  // 'settings.kb Activate previous active tab of active panel': { message: 'Активировать предыдущую активную вкладку на активной панели' },
  // 'settings.kb Move selected tabs to the active tab': { message: 'Вложить выделенные табы в активную вкладку' },
  // 'settings.kb Increase tab\'s tree level (indent)': { message: 'Увеличить уровень вкладки' },
  // 'settings.kb Decrease tab\'s tree level (outdent)': { message: 'Уменьшить уровень вкладки' },
  // 'settings.kb Move tabs up': { message: 'Переместить вкладки вверх' },
  // 'settings.kb Move tabs down': { message: 'Переместить вкладки вниз' },
